    ...
    <WalletProvider>
      <Router>
        <div className="min-h-screen bg-neutral-950 flex items-center justify-center p-4">
          <div className="w-[420px] h-[720px] bg-black text-white relative overflow-hidden rounded-[3rem]  border-neutral-900 shadow-2xl overflow-y-auto custom-scrollbar ">
            <Routes>
